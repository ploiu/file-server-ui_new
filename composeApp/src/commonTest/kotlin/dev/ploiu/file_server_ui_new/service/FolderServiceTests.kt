...
class FolderServiceTests {
    ...
    @Test
    fun `deleteFolder should not allow deleting root folder`() = runTest {
    ...
    @Test
    fun `getFolder should return an Err if id is less than 0`() = runTest {
    ...
    @Test
    fun `getFolder should call client getFolder with the passed id`() = runTest {
        val id = 123L
    ...
    @Test
    fun `downloadFolder should return an Err if id is less than 1`() = runTest {
    ...
    @Test
    fun `downloadFolder should call client downloadFolder with passed id`() = runTest {
        val id = 123L
        coEvery { folderClient.downloadFolder(id) } returns Response.success("".toResponseBody())

        folderService.downloadFolder(id)

        coVerify { folderClient.downloadFolder(id) }
    }

    @Test
    fun `getPreviewsForFolder should return an Err if passed id is less than 0`() = runTest {
    ...
    @Test
    fun `getPreviewsForFolder should call client getPreviewsForFolder with passed id`() = runTest {
        val id = 123L
        ...
        folderService.getPreviewsForFolder(id)

        coVerify { folderClient.getPreviewsForFolder(id) }
    }

    @Test
    fun `createFolder should return an Err if the parentId is less than 0`() = runTest {
    ...
    @Test
    fun `createFolder should return a Err if the name is a blank String`() = runTest {
    ...
    @Test
    fun `createFolder should call client createFolder with the passed request`() = runTest {
        ...
        folderService.createFolder(createFolder)
    ...
    @Test
    fun `updateFolder should return a Err if the passed name is a blank String`() = runTest {
    ...
    @Test
    fun `deleteFolder should return an Err if the passed id is less than 1`() = runTest {
        val result = folderService.deleteFolder(0)
        assertTrue(result.isErr)
        assertEquals("id (0) must be > 0", result.error)
    }
    ...
    @Test
    fun `deleteFolder should call client deleteFolder with the passed id`() = runTest {
        val id = 123L
