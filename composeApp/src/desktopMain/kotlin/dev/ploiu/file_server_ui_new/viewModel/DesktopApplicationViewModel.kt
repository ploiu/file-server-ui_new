...
class DesktopApplicationViewModel(
     ...
     */
    override fun uploadBulk(bulk: Collection<PlatformFile>, currentFolderId: Long) =
                    ...
                    if (errors.isNotEmpty()) {
                        ...
                        ErrorModal.open(
                            ErrorModalProps(
                                ...
                                onClose = this@DesktopApplicationViewModel::closeModal,
                            ),
                        )
                    }
     ...
     * TODO break this out into expect fun. No uploading entire folders on mobile because of OS rules and I don't want to
     */
