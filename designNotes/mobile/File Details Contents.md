...
- file stats and metadata
	- tapping on any of the metadata chips searches for other files with that same thing (e.g. tapping on the size chip searches for other files of the same size category)